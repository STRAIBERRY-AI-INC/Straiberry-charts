...
class BarChartRenderer(
    ...
    override fun preDraw(configuration: ChartConfiguration): Boolean {
        ...
        yLabels =  List(xLabelsStringForZeroToSeven.size) {
            Label(
    ...
    private fun placeLabelsY(innerFrame: Frame) {
        ...
        val heightBetweenLabels =
            (innerFrame.bottom - innerFrame.top) / RendererConstants.DefaultScaleNumberOfStepsForBarChart
        val labelsBottomPosition =
            innerFrame.bottom + painter.measureLabelHeight(chartConfiguration.labelsSize) / 6f
